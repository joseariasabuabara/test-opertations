...
public class MultiplicationRuleTest {
    ...
    public void multiplyRuleTest() {
        ...
        final OperationFact fact = new OperationFact("Multiplicacion", values);
        ...
        assertTrue(new BigDecimal(30).compareTo(new BigDecimal(result.get().toString())) == 0);
    }
}
