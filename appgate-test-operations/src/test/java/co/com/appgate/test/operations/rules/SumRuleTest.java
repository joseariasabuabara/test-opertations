...
public class SumRuleTest {
    ...
    public void sumRuleTest() {
        ...
        final OperationFact fact = new OperationFact("Suma", values);
        ...
        assertTrue(new BigDecimal(10).compareTo(new BigDecimal(result.get().toString())) == 0);
    }
}
